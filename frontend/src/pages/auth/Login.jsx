    ...
    <div className="relative min-h-screen bg-gray-50">
      ...
      <div className="absolute top-4 right-4 z-10">
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="text-white bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600 py-2 px-4 border border-transparent text-sm font-medium rounded-md transition-all shadow-md"
        >
          Home
        </motion.button>
      </div>
